...
# Antigravity IDE. The plain Antigravity build dropped its `agy` shim in 2.4.2,
# leaving ~/.antigravity/antigravity/bin a directory of dangling symlinks.
...
# Anything that should not be committed — tokens, one-off experiments, per-machine
# PATH entries. Optional; nothing here depends on it.
